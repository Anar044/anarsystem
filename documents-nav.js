(()=>{
  ...
  function ensureHrNav(){
    ...
    const path=currentPath();let link=null;if(path.endsWith('/hr-employees')||path.endsWith('/hr-employees.html'))link=group.querySelector('a[data-unified-nav-item="hr-employees.html"]');if(path.endsWith('/hr-role-schedules')||path.endsWith('/hr-role-schedules.html'))link=group.querySelector('a[data-unified-nav-item="hr-role-schedules.html"]');if(path.endsWith('/hr-compensation')||path.endsWith('/hr-compensation.html'))link=group.querySelector('a[data-unified-nav-item="hr-compensation.html"]');if(path.endsWith('/hr-payroll')||path.endsWith('/hr-payroll.html'))link=group.querySelector('a[data-unified-nav-item="hr-payroll.html"]');if(path.endsWith('/hr-timeclock')||path.endsWith('/hr-timeclock.html'))link=group.querySelector('a[data-unified-nav-item="hr-timeclock.html"]');if(path.endsWith('/hr-timesheet')||path.endsWith('/hr-timesheet.html'))link=group.querySelector('a[data-unified-nav-item="hr-timesheet.html"]');if(path.endsWith('/hr-calendar')||path.endsWith('/hr-calendar.html'))link=group.querySelector('a[data-unified-nav-item="hr-calendar.html"]');if(link)activateHr(group,link);return group;
  }
